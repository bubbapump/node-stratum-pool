...
var StratumClient = function(options){
    ...
    function handleAuthorize(message, replyToSocket){
        _this.workerAddress = message.params[0];
        _this.workerName = message.params[0] + '_' + _this.workerPass;
        _this.workerPass = message.params[1];
        options.authorizeFn(_this.remoteAddress, options.socket.localPort, _this.workerAddress, _this.workerPass, function(result) {
    ...
    function handleSubmit(message){
        ...
        _this.emit('submit',
            {
                name        : message.params[0] + '_' + _this.workerPass,
    ...
    this.getLabel = function(){
        return (_this.workerName + '_' + _this.workerPass || '(unauthorized)') + ' [' + _this.remoteAddress + ']';
    };
